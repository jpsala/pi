...
- Renderer de tools: actual adoptado `pi-code-previews@0.1.36`; anterior `pi-claude-code-ui@1.0.74`, instalada pero filtrada con `extensions: []`. Estado, toggle y rollback canonicos en `docs/topics/pi-tool-renderer.md`; no restaurar completo el backup historico `~/.pi/agent/backups/code-previews-trial-20260722-100300/` porque antecede a settings posteriores.
