---
name: gol-lite
description: Execute the next small, verifiable AOS work batch without using Pi until-done. Use when JP says `gol`, `gol-lite`, `avancemos`, `ejecutar lote`, or wants lightweight progress with context and verification.
---
